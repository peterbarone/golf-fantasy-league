...
import GolferResults from '@/components/dashboard/GolferResults';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-8">
        <div>
          <h2 className="text-2xl font-semibold mb-4">Tournament Settings</h2>
          <TournamentDetail tournamentId={tournamentId} />
        </div>
        
        <div>
          <h2 className="text-2xl font-semibold mb-4">Golfer Results</h2>
          <GolferResults tournamentId={tournamentId} />
        </div>
      </div>
    </div>
  );
