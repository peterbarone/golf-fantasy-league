    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <p className="text-gray-600">
          Manage teams for your league. Create new teams, assign owners, and manage team rosters.
          Teams need to be created before owners can submit lineups for tournaments.
        </p>
      </div>
