    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <p className="text-gray-600">
          View the current league standings with total points, average points per tournament, and total skins for each team.
          Click on a team to see their performance in individual tournaments.
        </p>
      </div>
